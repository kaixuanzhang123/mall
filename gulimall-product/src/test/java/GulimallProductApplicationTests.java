...
//        String accessKeyId = "LTAI4G7Wd8VcTDhae9HpafUp";
//        String accessKeySecret = "NFTagK04gdwErDfkC60pnFFzLOVBCd";
//
//        // 创建OSSClient实例。
//        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
//
//        // 上传文件流。
//        InputStream inputStream = new FileInputStream("F:\\中高级面试\\【No1056】谷粒商城2020分布式\\1.分布式基础篇\\1.分布式基础篇\\资料源码\\docs" +
//                "\\pics\\0d40c24b264aa511.png");
